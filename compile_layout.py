...
<picture>
  ...
  <img alt="Product Stack" src="assets/header-stack-dark.svg?v={ts}" width="100%" />
</picture>
...
<picture>
  ...
  <img alt="GitHub Metrics" src="assets/header-stats-dark.svg?v={ts}" width="100%" />
</picture>
...
<div align="center" style="margin-top: -10px;">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=6366f1,a855f7&height=100&section=footer&v={ts}" width="100%" alt="Footer"/>
</div>
"""
